...
public struct CCSPlayerInventory_Loadouts
{
  ...
  [UnscopedRef]
  public ref LoadoutItem this[Team team, loadout_slot_t slot] => ref this[(int)team, (int)slot];

  [UnscopedRef]
  public ref LoadoutItem this[int team, int slot] => ref _element0[team][slot];
